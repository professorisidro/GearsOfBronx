	...
	public void update(float delta) {
		...
		for (AbstractModel m : objects) {
			...
			if (m instanceof Poste) {
				...
				Vector3 posPoste = new Vector3();
				Vector3 posLixo = new Vector3();
				m.getGameObject().transform.getTranslation(posPoste);
				lixo.getGameObject().transform.getTranslation(posLixo);
